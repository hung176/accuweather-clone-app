    ...
    <div className="flex flex-col p-3 justify-start items-center bg-white">
      <div className="w-full flex flex-col sm:flex-row sm:justify-between sm:items-start">
        <div className="flex flex-col">
          <div className="flex flex-col">
            <span className="font-semibold">CURRENT WEATHER</span>
            <span>{conditions.time}</span>
          </div>
          <div className="flex justify-center items-center ml-4">
            <img className="w-24 h-24 mr-2" src={conditions.weatherIcon} alt="to-day-weather" />
            <div className="flex flex-col justify-center items-center">
              <span className="text-7xl text-gray-500">{conditions.temperature}</span>
